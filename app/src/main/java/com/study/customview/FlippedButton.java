...
/**
 * Author by dengdai, Email 291996307@qq.com, Date on 2019/9/20.
 */
public class FlippedButton extends LinearLayout {
    ...
    public FlippedButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
